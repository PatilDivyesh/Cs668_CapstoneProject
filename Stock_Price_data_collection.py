...
# Access Twitter API keys using python-decouple
api_access_key = config('MARKET_STACK_API') 
...
# Define the start date (Jan 1st of the current year)
...
csv_file_name = 'stock_price_data_Jan_2020_to_Oct_2023.csv'
...
print(f'Data from Jan 1st to Oct 24th has been saved to {csv_file_name}')
